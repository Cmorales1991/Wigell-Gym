        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/wigellgym/listcanceled",
                                ...
                                "/api/wigellgym/updateinstructor/**",
                                "/api/wigellgym/reminstructor/**",
                                "/api/wigellgym/addcustomer",
                                "/api/wigellgym/updatecustomer/**",
                                "/api/wigellgym/remcustomer/**",
                                "/api/wigellgym/customers/**")
                        .hasRole("ADMIN")

                        .requestMatchers(
                                "/api/wigellgym/workout",
                                "/api/wigellgym/instructors",
